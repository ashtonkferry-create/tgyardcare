              ...
              <GlassCard variant="dark" hover="none" className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/25 text-[11px] mt-1.5 ml-8">By providing your phone number, you consent to receive service-related texts. Reply STOP to opt out. See our <a href="/privacy" className="underline hover:text-white/40 transition-colors">Privacy Policy</a> &amp; <a href="/terms" className="underline hover:text-white/40 transition-colors">Terms</a>.</p>
                  </div>
