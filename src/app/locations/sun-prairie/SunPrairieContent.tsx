...
const cityName = "Sun Prairie";
const cityDescription = "Professional lawn care and landscaping services for Sun Prairie homes and businesses. Quality service with a personal touch from your local lawn care experts.";

export default function SunPrairieContent() {
  const services = [
  ...
  return (
    <div className="min-h-screen" style={{ background: '#050d07' }}>
      ...
      <LocationPageSchemas citySlug="sun-prairie" faqs={[
      ...
      <BreadcrumbSchema items={[
        ...
        { name: `${cityName}, WI`, url: `https://totalguardyardcare.com/locations/sun-prairie` }
      ]} />
      <WebPageSchema name={`Lawn Care in ${cityName}, WI`} description={`Professional lawn care services in ${cityName}, WI`} url="/locations/sun-prairie" />
