...
const cityName = "Cottage Grove";
const cityDescription = "Professional lawn care and landscaping services for Cottage Grove homes and businesses. Quality service with a personal touch from your local lawn care experts.";

export default function CottageGroveContent() {
  const services = [
  ...
  return (
    <div className="min-h-screen" style={{ background: '#050d07' }}>
      ...
      <LocationPageSchemas citySlug="cottage-grove" faqs={[
      ...
      <BreadcrumbSchema items={[
        ...
        { name: `${cityName}, WI`, url: `https://totalguardyardcare.com/locations/cottage-grove` }
      ]} />
      <WebPageSchema name={`Lawn Care in ${cityName}, WI`} description={`Professional lawn care services in ${cityName}, WI`} url="/locations/cottage-grove" />
