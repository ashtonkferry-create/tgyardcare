...
const cityDescription = "Professional lawn care and landscaping services for Verona homes and businesses. Quality service with a personal touch from your local lawn care experts.";

export default function VeronaContent() {
  const services = [
  ...
  return (
    <div className="min-h-screen" style={{ background: '#050d07' }}>
      ...
      <LocationPageSchemas citySlug="verona" faqs={[
      ...
      <BreadcrumbSchema items={[
        ...
        { name: `${cityName}, WI`, url: `https://totalguardyardcare.com/locations/verona` }
      ]} />
      <WebPageSchema name={`Lawn Care in ${cityName}, WI`} description={`Professional lawn care services in ${cityName}, WI`} url="/locations/verona" />
