...
const cityName = "Monona";
const cityDescription = "Professional lawn care and landscaping services for Monona homes and businesses. Quality service with a personal touch from your local lawn care experts.";

export default function MononaContent() {
  const services = [
  ...
  return (
    <div className="min-h-screen" style={{ background: '#050d07' }}>
      ...
      <LocationPageSchemas citySlug="monona" faqs={[
      ...
      <BreadcrumbSchema items={[
        ...
        { name: `${cityName}, WI`, url: `https://totalguardyardcare.com/locations/monona` }
      ]} />
      <WebPageSchema name={`Lawn Care in ${cityName}, WI`} description={`Professional lawn care services in ${cityName}, WI`} url="/locations/monona" />
