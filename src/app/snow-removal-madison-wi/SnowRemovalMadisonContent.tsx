...
export default function SnowRemovalMadisonContent() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <LocationPageSchemas citySlug="madison" faqs={faqs} />
      ...
      <WebPageSchema name="Snow Removal Madison WI" description="Professional snow removal in Madison, WI" url="/snow-removal-madison-wi" />
