...
export default function LocationPageTemplate({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Hero Section */}
      <section className={cn("relative min-h-[auto] md:min-h-[60vh] flex items-center py-16 pt-20 md:py-24 md:pt-24 bg-foreground/95", MOBILE_ORDER.HERO)}>
        <div
...
>
      ...
      {/* Services Section */}
      <section className={cn("py-12 md:py-16 bg-background", MOBILE_ORDER.WHATS_INCLUDED)}>
      ...
      <section className={cn("py-12 md:py-16 bg-muted/30", MOBILE_ORDER.WHY_CHOOSE)}>
        <div className="container mx-auto px-4">
      ...
      <div className={MOBILE_ORDER.HOW_IT_WORKS}><WhatHappensNextSection /></div>
      ...
      <div className={MOBILE_ORDER.BOTTOM_CTA}><CTASection /></div>
